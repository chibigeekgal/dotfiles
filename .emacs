...
;;  These lines makes Emacs use this Prolog mode automatically
;;  when editing files with a .pl extension: 

(setq load-path (cons "/usr/lib/sicstus4.2.1/lib/sicstus-4.2.1/emacs/" load-path))
